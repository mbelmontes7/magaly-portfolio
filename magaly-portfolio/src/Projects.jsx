...
const projects = [
    ...
    },
    {
        ...
        textColor: 'text-slate-950',
        number: '02',
        description: 'The app includes a jersey roulette picker, a juggling dice game with scoreboard, and an interactive soccer field challenge page.',
        link: 'https://futbolmagaly-122b8.web.app/',
        tags: ['UI Design', 'Firebase', 'Frontend']
    },
    {
        id: 'WorldMap',
        title: 'World Map',
        spineLabel: 'World Map',
        subtitle: 'Interactive geography learning tool',
        accent: 'from-blue-300/40 via-cyan-400/30 to-emerald-300/25',
        bookColor: 'bg-[linear-gradient(180deg,#79d5ef_0%,#2b7fd7_100%)]',
        edgeColor: 'bg-[#1f5fab]',
        textColor: 'text-slate-950',
        number: '03',
        description: 'This project uses the World Bank API to fetch and display country data through an interactive SVG map. When a user clicks a country, its SVG path ID is captured in getCountryData(), then sent to the API service to retrieve detailed information.',
        link: 'https://github.com/mbelmontes7/map',
        tags: ['Interaction', 'Motion', 'Concept']
    },
    {
        id: 'birthday-card',
        title: 'Dominic Birthday Card',
        spineLabel: 'Birthday Card',
        subtitle: 'Interactive digital greeting experience',
        accent: 'from-pink-300/35 via-rose-300/20 to-yellow-300/20',
        bookColor: 'bg-[linear-gradient(180deg,#f9a8d4_0%,#fb7185_100%)]',
        edgeColor: 'bg-[#be185d]',
        textColor: 'text-slate-950',
        number: '05',
        description: 'An interactive birthday card web app where users can send Dominic birthday messages, add optional photos, and view shared wishes in one place.',
        link: 'https://dominic-birthday-card.web.app/',
        tags: ['HTML', 'CSS', 'JavaScript']
    },
    {
        id: 'Soccer section planner',
        title: 'Soccer Section Planner',
        spineLabel: 'Soccer Section Planner',
        subtitle: 'Interactive 7v7 coaching board',
        accent: 'from-emerald-300/35 via-lime-300/20 to-cyan-300/20',
        bookColor: 'bg-[linear-gradient(180deg,#86efac_0%,#16a34a_100%)]',
        edgeColor: 'bg-[#166534]',
        textColor: 'text-slate-950',
        number: '05',
        description: 'A coaching tool for planning 7v7 soccer sessions with draggable players, formation presets, equipment placement, and structured practice notes.',
        // link: 'https://your-project-link.com',
        tags: ['Productivity', 'COACHING', 'Journal app']
    },
    {
        id: 'SoccerAI',
        title: 'SoccerAI',
        spineLabel: 'SoccerAI',
        subtitle: 'AI-powered soccer video editor concept',
        accent: 'from-emerald-300/35 via-lime-300/20 to-cyan-300/20',
        bookColor: 'bg-[linear-gradient(180deg,#b8efb4_0%,#51a270_100%)]',
        edgeColor: 'bg-[#3f8058]',
        textColor: 'text-slate-950',
        number: '06',
        description: 'This app concept uses AI to analyze soccer game footage to select a player and create a personalized highlight reel. Users can input game videos, and the AI identifies key moments, generating a shareable highlight video focused on the selected player.',
        tags: ['Sports', 'Video editor', 'AI']
    }
];
